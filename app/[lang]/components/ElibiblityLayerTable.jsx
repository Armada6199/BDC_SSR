        ...
        <TableHead>
          <TableRow sx={{ bgcolor: "#fff" }}>
            <TableCell sx={{ fontWeight: "700" }} align="left">
              {loanEligibilityTable.layer}
            </TableCell>
            <TableCell sx={{ fontWeight: "700" }} align="left">
              {" "}
              {loanEligibilityTable.loanType}
            </TableCell>
            <TableCell sx={{ fontWeight: "700" }} align="left">
              {loanEligibilityTable.loanStatus}
            </TableCell>
            <TableCell sx={{ fontWeight: "700" }} align="left">
              {loanEligibilityTable.appliedAmount}
            </TableCell>
            <TableCell sx={{ fontWeight: "700" }} align="left">
              {loanEligibilityTable.appliedInterest}
            </TableCell>
            <TableCell sx={{ fontWeight: "700" }} rowSpan={2} align="left">
              {loanEligibilityTable.layerInterestRate}
            </TableCell>
            <TableCell sx={{ fontWeight: "700" }} align="left">
              {loanEligibilityTable.range}
            </TableCell>
  ...
  <TableRow >
    <TableCell sx={{fontWeight:'700',borderBottom:"none",fontSize:16,color:'secondary.dark'}}   colSpan={12} align="left">{layer.title}</TableCell>
            ...
            <TableBody>
              <TableRow sx={{ bgcolor: "#fff" }}>
                <TableCell
                  sx={{ fontWeight: "600", border: "1px solid lightgray" }}
                  rowSpan={2}
                >
                ...
                <TableCell
                  sx={{ fontWeight: "600", border: "1px solid lightgray" }}
                >
                  {loanEligibilityTable.requested}
                </TableCell>
                <TableCell
                  sx={{ fontWeight: "600", border: "1px solid lightgray" }}
                >
